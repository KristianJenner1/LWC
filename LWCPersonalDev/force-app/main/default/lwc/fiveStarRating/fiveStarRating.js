...
export default class FiveStarRating extends LightningElement {
    ...
    get starClass() {
        // return READ_ONLY_CLASS or EDITABLE_CLASS based on this.readOnly using a ternary operator
    ...
    ratingChanged(rating) {
        ...
        // Create the const ratingChanged event
        const ratingChangedEvent = new CustomEvent('ratingchange', {
            detail: {
                rating: rating
            }
        });
        // Fire the custom event ratingChanged
